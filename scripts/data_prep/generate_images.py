...
class PoreImageGenerator:
    ...
    def __init__(self, config_path: str = _DEFAULT_CONFIG_PATH):
        ...
        self._clean_dir = output_settings.get("clean_dir", "./artifacts/generated/synthetic/clean_background")
        self._noisy_dir = output_settings.get("noisy_dir", "./artifacts/generated/synthetic/noisy_background")
